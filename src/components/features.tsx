        ...
        <section id="features" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 bg-millimabg relative z-0 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-neutral-950">
                <div className="relative w-full h-full">
                    <div className="absolute inset-0 bg-neutral-950/5 backdrop-blur-3xl"></div>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="mb-24 text-center">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-7xl font-semibold tracking-tighter text-white leading-[1.1] sm:leading-[1.05] mb-4 sm:mb-6">
                        Messaging, <span className="text-slate-500">Reimagined.</span>
                    </h2>
                    <p className="text-base sm:text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
                        Messenger built for speed, privacy, and productivity.
                    </p>
                </div>
