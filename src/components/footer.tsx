...
export const Footer = () => {
  return (
    <footer
      id="contact"
      className="bg-black relative pt-16 sm:pt-24 lg:pt-32 pb-8 sm:pb-12 overflow-hidden"
    >
      {/* main links and info */}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center md:pl-12 md:border-l border-white/10 lg:pl-16 gap-12">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col gap-2 text-sm font-medium text-slate-500">
                <a
                  href="mailto:hello@milima-messenger.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors flex items-center gap-2 w-fit"
                >
                  <Icon icon="solar:letter-linear" className="text-xl" />
                  hello@millima-messenger.com
                </a>
                <a
                  href="tel:+15550002548"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors flex items-center gap-2 w-fit"
                >
              ...
              <div className="flex flex-col gap-2 w-fit">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors flex items-center gap-2 w-fit text-sm font-medium text-slate-500"
                >
